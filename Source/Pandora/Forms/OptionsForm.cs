...
namespace TheBox.Forms
{
	...
	public class OptionsForm : Form
	{
		...
		{
			var resources = new System.Resources.ResourceManager(typeof(OptionsForm));
			...
			this.lnkLinkColor.LinkClicked +=
				new System.Windows.Forms.LinkLabelLinkClickedEventHandler(this.lnkLinkColor_LinkClicked);
			// 
			// txLinkColor
			// 
			...
			this.linkSpawnColor.LinkClicked +=
			...
			this.lnkViewDataFolder.LinkClicked +=
				new System.Windows.Forms.LinkLabelLinkClickedEventHandler(this.lnkViewDataFolder_LinkClicked);
			...
			// cmImport
			// 
			this.cmImport.MenuItems.AddRange(
				new System.Windows.Forms.MenuItem[]
					{this.cmImportBoxData, this.cmImportPropsData, this.cmImportSpawnData, this.cmImportSpawnGroups});
			// 
			// cmImportBoxData
			// 
